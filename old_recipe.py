...
from old_transform import TransformILM
...
class OldILM(AttackRecipe):
    @staticmethod
    def build(model, infill_dirpath=None, max_candidates=10, threshold=0.8, dataset='yelp_polarity'):

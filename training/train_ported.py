# This file only exists because newer versions of HuggingFace turn model outputs into dicts instead of tuples.
# Who knows--we might just revert our transformers version and remove this file.
  ...
  if args.eval_only:
    ...
    for i, eval_batch in enumerate(eval_dataloader):
      with torch.no_grad():
        ...
        eval_logits, _ = model(eval_inputs).values()
